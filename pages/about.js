  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome the Launch Tech LLC team, along with our advisors! Get to know the people that create, build, market, and deploy all of Launch Tech's SaaS products and software applications!"
        />
      </Head>
        ...
        <div className="page-container container">
          ...
          <div className="persons mt-3">
              ...
              <div className="person-content">
                <div className="person-info">
                  ...
                  <div className="person-info-links">
                    <a
                      href="https://www.instagram.com/calix_huang/"
                      target="_blank"
                    >
            ...
            <div className="person" data-aos="zoom-in">
              ...
              <div className="person-content">
                <div className="person-info">
                  ...
                  <div className="person-info-links">
                    <a
                      href="https://www.instagram.com/kenny.wu/"
                      target="_blank"
                    >
                      <img src="img/icons/social-media/instagram-dark.svg" />
                    </a>
            ...
            <div className="person" data-aos="zoom-in">
              <div className="image-cropper">
                <img
                  src="img/people/jasmine.png"
                  alt="Launch Tech LLC - Jasmine Cho"
                  className="person-image"
                />
              </div>
              <div className="person-content">
                <div className="person-info">
                  ...
                  <div className="person-info-links">
                    <div></div>
                    <a
                      href="https://www.linkedin.com/in/eunsuh-jasmine-cho-408874166/"
                      target="_blank"
                    >
                      <img src="img/icons/social-media/linkedin-dark.svg" />
                    </a>
                ...
                <small className="person-description">
                  Jasmine Cho is a prospective computer science major, and is
                  currently the team captain of her Varsity tennis team and the
                  Concertmaster for the Symphony Orchestra. Aside from
                  academics, you can find her food adventuring, paddle boarding
                  or hiking.
                </small>
              </div>
            </div>
              ...
              <div className="person-content">
                <div className="person-info">
                  ...
                  <div className="person-info-links">
                    ...
                    <a
                      href="mailto:jaanavi.thanamala@gmail.com"
                      target="_blank"
                    >
                      <img src="img/icons/contact/email-dark.svg" />
                    </a>
              ...
              <div className="person-content">
                <div className="person-info">
                  ...
                  <div className="person-info-links">
                    ...
                    <div></div>
                    <a
                      href="mailto:elizabeth@launchtechllc.com"
                      target="_blank"
                    >
                      <img src="img/icons/contact/email-dark.svg" />
                    </a>
