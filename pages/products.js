          ...
          <div className="products">
            ...
            <div className="product">
              <div className="product-content-show">
                <h2>Ano.js</h2>
                <p>
                  Ano.js is a free, open-source web animation library, allowing
                  anyone to integrate customizable web animations into any
                  website with just two lines of code! You can customize the
                  colors of the animation you want in real-time, and copy-paste
                  the code into any HTML file. It has been transformed to an
                  open-source , and animations are now being created and
                  optimized by open-source contributors.
                </p>
                <div className="product-content-cta">
                  <div className="product-content-cta-left">
                    <span>Node.js</span>
            ...
            <div className="product">
              ...
              <div className="product-content">
                <h2>w3Hacks</h2>
                <p>
                  w3Hacks is an online platform where anyone can learn how to
                  code! Whether you're a seasoned programmer or a semi-beginner,
                  everyone has something to learn here! We reinforce and teach
                  good, real-world programming skills that are used in the
                  software engineering industry, and crucial skills for any
                  developer to know whether they're making a solo or working
                  with others!
                </p>
                <div className="product-content-cta">
                  <div className="product-content-cta-left">
