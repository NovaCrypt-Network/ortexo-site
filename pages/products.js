          ...
          <div className="products">
            ...
            <div className="product">
              <div className="product-images" data-aos="zoom-in">
                <img className="product-images-1" src="img/products/npocore/desktop.png" alt="Launch Tech LLC - w3Hacks - Website Image" />
                <img className="product-images-2" src="img/products/npocore/tablet.png" alt="Launch Tech LLC - w3Hacks - Website Image" />
                <img className="product-images-3" src="img/products/npocore/mobile.png" alt="Launch Tech LLC - w3Hacks - Website Image" />
              </div>
            ...
            <div className="product">
              <div className="product-content-show">
                <h2>AveryBot</h2>
                <p>
                  Avery is an AI chatbot embedded into a text-messaging application powered by Twilio. Avery is there for anyone struggling with mental health issues or just wanting rant about any of the problems in your life! Avery is a great way to just list out all your problems and gain some clarity.
                </p>
                <p>
                  Creator:
                  <a href="https://www.calix.dev" target="_blank">@calixo888</a>
                ...
                <div className="product-content-cta">
                  ...
                  <div className="product-content-cta-right">
                    <a href="https://github.com/launchtechllc/averybot" target="_blank">
                      <img src="img/icons/social-media/github-dark.svg" alt="Launch Tech LLC - AveryBot - A mental-health text-message application" />
                    </a>
                    <a href="https://averybot.webflow.io/" target="_blank">
                      <img src="img/icons/contact/out-dark.svg" alt="Launch Tech LLC - AveryBot - A mental-health text-message application" />
                    </a>
                  </div>
                </div>
              </div>
              <div className="product-images" data-aos="zoom-in">
                <img className="product-images-1" src="img/products/averybot/desktop.png" alt="Launch Tech LLC - Ano.js - Website Image" />
                <img className="product-images-2" src="img/products/averybot/tablet.png" alt="Launch Tech LLC - Ano.js - Website Image" />
                <img className="product-images-3" src="img/products/averybot/mobile.png" alt="Launch Tech LLC - Ano.js - Website Image" />
              </div>
              <div className="product-content-hidden">
                <h2>AveryBot</h2>
                <p>
